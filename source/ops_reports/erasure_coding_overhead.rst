...
.. ifconfig:: persona != 'customer'
   ...
   In the :guilabel:`Erasure Coding Overhead` report you can see the ratio between the actual user data 
   capacity and the erasure coding overhead capacity. The panel label also indicates the raw capacity that 
   is taken by the erasure coding.
