.. ifconfig:: persona == 'oem'
   ...
   .. note::
      ...
      The options in the user properties vary according the "Persona", for example a Customer persona is 
      not able to add a user with an OEM persona.
   ...
   #. Fill out the row with the proper values:
      ...
      * :guilabel:`Persona`: this value defines the information that the user will see in the UI (Customer, 
        OEM). See :ref:`User Roles <user_roles_oem>` for more information.
      ...
      * :guilabel:`Role`: the role of the user (User, Super User). See :ref:`User Roles
        <user_roles_oem>` for more information.
